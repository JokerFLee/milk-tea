	...
	<div class="np ">
		...
		<div class="opbox">
			...
			<div class="op1div" v-show="sideshow">
				...
				<div class="op1div-common" @click="v2 = !v2;[v1, v3, v4] = [false]">
					<div class="op1div-title">
						<div class="image-common b22"></div> <span>日常消耗品</span>
					</div>
					<ul v-show="v2">
						<router-link to="/">
							<li>库存总览</li>
				...
				<div class="op1div-common" @click="v3 = !v3;[v1, v2, v4] = [false]">
					<div class="op1div-title">
				...
				<div class="op1div-common" @click="v4 = !v4;[v2, v3, v1] = [false]">
					<div class="op1div-title">
